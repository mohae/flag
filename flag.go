// Copyright 2014, Joel Scoble, github.com/mohae
// Use of this source code is governed by a BSD-style
// license that can be found in the LICENSE file.
//
// This file is based on Go's log package and the original
// copyright notice follows. No additional claims or warranties,
// implied or otherwise are made by Joel Scoble.
//
...
func TimeVar(p *time.Time, name string, value time.Time, usage string) {
	CommandLine.Var(newTimeValue(value, p), name, usage)
}
...
// Time defines a time.Time falg with specified name, default value, and usage string.
// The return value is the address of a time.Time variable that stores the falue of hte flag.
